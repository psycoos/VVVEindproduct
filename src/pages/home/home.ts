...
export class HomePage {
  ...
  cities = [
    ...
    { id: 6, name: "Hindeloopen", stamped: false, checked: "hindeloopen/hindeloopen_2.svg", unchecked: "hindeloopen/hindeloopen_1.svg"},
    ...
    { id: 11, name: "Dokkum", stamped: false, checked: "dokkum/dokkum_2.svg", unchecked: "dokkum/dokkum_1.svg"}
  ];  
